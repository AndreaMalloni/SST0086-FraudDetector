...
class StabilityAnalyzer:
    def __init__(self, model_path: Path, training_data: pd.DataFrame, noise_multiplier: float = 0.01):
        ...
        """
        self.logger = LoggingManager().get_logger("StabilityAnalysis")
    ...
    def calculate_stability_metrics(self,
        ...
        original_values = np.array([v for v in original_importance.values()])
        perturbed_values = np.array([v for v in perturbed_importance.values()])
        cosine_sim = cosine_similarity(
            original_values.reshape(1, -1),
            perturbed_values.reshape(1, -1)
        )[0][0]
    ...
    def analyze_stability(self,
                         ...
                         method: str,
                         n_perturbations: int = 5) -> Dict[str, Any]:
    ...
    def _plot_stability_metrics(self,
                              ...
                              jaccard_indices: Dict[int, List[float]],
                              idx: int):
